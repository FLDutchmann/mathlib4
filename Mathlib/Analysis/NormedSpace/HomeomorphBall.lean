...
def PartialHomeomorph.univUnitBall : PartialHomeomorph E E where
  ...
  left_inv' x _ := by
    simp [fieldExpr, -one_div, norm_smul, smul_smul, (zero_lt_one_add_norm_sq x).ne', sq_abs,
  ...
  right_inv' y hy := by
    ...
    simp [fieldExpr, -one_div, norm_smul, smul_smul, this.ne', sq_abs, Real.sq_sqrt this.le,
